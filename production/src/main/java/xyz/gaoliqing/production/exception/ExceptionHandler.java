...
public class ExceptionHandler {
    ...
    public AjaxResponse customerException(CustomException e) throws CloneNotSupportedException {
        if (500 == e.getCode()) log.error("自定义已知报错信息------>"+e.getMessage());
        return AjaxResponse.error(e);
    }

    @org.springframework.web.bind.annotation.ExceptionHandler(Exception.class)
    public AjaxResponse exception(Exception e) throws CloneNotSupportedException {
